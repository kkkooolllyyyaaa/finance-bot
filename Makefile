...
PACKAGE=gitlab.ozon.dev/kolya_cypandin/project-base/cmd/bot
...
generate: install-mockgen
	#${MOCKGEN} -source=internal/model/messages/msg_mgmt.go -destination=internal/mocks/messages/messages_mocks.go
